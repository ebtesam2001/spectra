            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr v-for="news in news" :key="news.id">
                        ...
                        <td class="px-6 py-4">
                            <img :src="news.image" class="w-10 h-10 rounded-full" />
                        </td>
                        <td class="px-6 py-4 flex">
                            <a @click="editForm(news.id)"
    ...
    " required />
                        ...
                        <div class="w-full">
                            <div class="mb-5">
                                ...
                                <input type="date" id="name" v-model="addData.date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-400 focus:border-ring-cyan-400 block w-full p-2.5
    " required />
                            </div>
                        ...
                        <div class="w-full">
                            <div class="mb-5">
                                ...
                                <input type="text" id="name" v-model="addData.description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-400 focus:border-ring-cyan-400 block w-full p-2.5
    " required />
                            </div>
                    ...
                    <div class="my-6 ">
                        ...
                        <div class="w-full mt-4">
                            <div class="mb-5">
                                ...
                                <input type="date" id="name" v-model="editData.date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-400 focus:border-ring-cyan-400 block w-full p-2.5
    " required />
                            </div>
...
export default {
    ...
    methods: {
        store() {
            ...
            form.append("date", this.addData.date);
            form.append("description", this.addData.name);
            form.append("image", this.addData.image);

            axios
                .post(route("newsManage.store"), form)
                .then((r) => {
                    // console.log(r)
                    this.isShow = false
                    this.image = "";
        ...
        update() {
            ...
            form.append("date", this.editData.date);
            ...
            axios
                .post(
                    route("newsManage.update", { id: this.editData.id }),
                    form
                )
                .then((r) => {
        ...
        deleteFun(ids) {
            axios
                .delete(route("newsManage.destroy", { id: ids }))
                .then((r) => {
                    window.location.reload();
                })
                .catch((er) => {
