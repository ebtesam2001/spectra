...
export default(await import('vue')).defineComponent( {
    ...
    methods: {
        store() {
            ...
            axios
                .post(route("categories.store"), form)
                .then((r) => {
                    // console.log(r)
                    this.isShow = false
                    this.addData = {
        ...
        update() {
            ...
            axios
                .post(
                    route("categories.update", { id: this.editData.id }),
                    form
                )
                .then((r) => {
        ...
        deleteFun(ids) {
            axios
                .delete(route("categories.destroy", { id: ids }))
                .then((r) => {
                    window.location.reload();
                })
                .catch((er) => {
