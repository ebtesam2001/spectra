            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr v-for="project in projects" :key="project.id">
                        ...
                        <td class="px-6 py-4">
                            <img :src="project.image" class="w-10 h-10 rounded-full" />
                        </td>

                        <td class="px-6 py-4 flex">
                            <a @click="editForm(project.id)"
...
export default {
    ...
    methods: {
        store() {
            ...
            axios
                .post(route("projects.store"), form)
                .then((r) => {
                    // console.log(r)
                    this.isShow = false
                    this.image = "";
        ...
        update() {
            ...
            axios
                .post(
                    route("projects.update", { id: this.editData.id }),
                    form
                )
                .then((r) => {
        ...
        deleteFun(ids) {
            axios
                .delete(route("projects.destroy", { id: ids }))
                .then((r) => {
                    window.location.reload();
                })
                .catch((er) => {
